...
//MANISH's CODE END ----	
	...
	function get_addons(){
		return apply_filters('wplms_lms_addons',array(
			'wplms-activecampaign' =>array(
					'label'=> __('WPLMS ActiveCampaign','vibe-customtypes'),
					'sub'=> __('Active Campaign integration with WPLMS','vibe-customtypes'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_activecampaign_license_key',
					'link' => 'https://wplms.io/downloads/wplms-activecampaign/',
					'extra'=>array('Auto-create Lists','Sync lists','Subscribe Widget'),
					'activated'=> (is_plugin_active('wplms-activecampaign/wplms-activecampaign.php')?true:false),
					'file'=>'wplms-activecampaign/wplms-activecampaign.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
			'wplms-getresponse' =>array(
					'label'=> __('WPLMS GetResponse','vibe-customtypes'),
					'sub'=> __('GetResponse integration with WPLMS','vibe-customtypes'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_getresponse_license_key',
					'link' => 'https://wplms.io/downloads/wplms-getresponse/',
					'extra'=>array('Auto-create Lists','Sync lists','Subscribe Widget'),
					'activated'=> (is_plugin_active('wplms-getresponse/wplms-getresponse.php')?true:false),
					'file'=>'wplms-getresponse/wplms-getresponse.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
			'wplms-groundhogg' =>array(
					'label'=> __('WPLMS GroundHogg','vibe-customtypes'),
					'sub'=> __('GroundHogg CRM integration with WPLMS','vibe-customtypes'),
					'icon'=> '<span class="dashicons dashicons-portfolio"></span>',
					'requires'=> '',
					'license_key'=>'wplms_groundhogg_license_key',
					'link' => 'https://wplms.io/downloads/wplms-groundhogg/',
					'extra'=>array('Auto-tag Users','Create Course Tags'),
					'activated'=> (is_plugin_active('wplms-groundhogg/wplms-groundhogg.php')?true:false),
					'file'=>'wplms-groundhogg/wplms-groundhogg.php',
					'price'=>'BUY $19',
					'class'=>'featured'
				),
