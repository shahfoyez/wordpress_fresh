			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="https://wplms.io/support/knowledge-base/3-9-9/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						...
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/wplms_vibe_zoom.jpg' ?>" alt="reactquiz">
							<a href="https://wplms.io/support/knowledge-base/vibe-zoom-integration/" class="button" target="_blank">Link</a>
						</p>

					</div>
					<div>
						<h4>Prepare for 4.0</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/wplms_4.0.png' ?>" alt="reactquiz">
						</p>
