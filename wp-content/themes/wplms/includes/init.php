...
function register_required_plugins() {
    ...
    $plugins = array(
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddypress.5.2.0.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/woocommerce.4.1.0.zip', // The plugin source
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/bbpress.2.6.4.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => 'https://downloads.wordpress.org/plugin/buddydrive.2.1.2.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
