          ...
          <form name="login-form" id="vbp-login-form" class="standard-form" action="<?php echo apply_filters('wplms_login_widget_action',site_url( 'wp-login.php', 'login_post' )); ?>" method="post">
            <div class="inside_login_form">
              ...
              <div class="foy-right-bottom">
                ...
                <div class="foy-social-login">
                  <a href="https://www.oneeducation.org.uk/wp-login.php?loginSocial=google&redirect=https%3A%2F%2Fwww.oneeducation.org.uk%2F" ><img src="http://localhost/fresh/wp-content/uploads/2022/10/search-1.png"></a> 
                  
                  <a href="#"><img src="http://localhost/fresh/wp-content/uploads/2022/10/facebook-1.png"></a> 
                </div>
                <div class="foy-signup">
                   <p>Not a member yet?<a href="#" class="foy-su"> Sign up</a></p>
                </div>
              </div>
            </div>    
          </form>
